...
import 'package:cinematic_insights/screens/LoginScreens/forgot_password_screen.dart';
import 'package:cinematic_insights/screens/home_screen.dart';
import 'package:cinematic_insights/screens/LoginScreens/login_register_screen.dart';
                        ...
                        GestureDetector(
                          onTap: ()
                          {
                            Navigator.push(context,
                                ...
                                {
                                  return ForgotPasswordScreen(currentlyPlaying: widget.currentlyPlaying,trendingYr: widget.trendingYr,highestGrossing: widget.highestGrossing,childrenFriendly: widget.childrenFriendly,onTv: widget.onTv);
                                },
                              ),
                            );
                          },
                ...
                Row(
                  ...
                  children: [
                    ...
                    GestureDetector(
                      onTap: ()
                      {
                        Navigator.push(context, MaterialPageRoute(builder: ((context) => loginRegisterPage(currentlyPlaying: widget.currentlyPlaying,trendingYr: widget.trendingYr,highestGrossing: widget.highestGrossing,childrenFriendly: widget.childrenFriendly,onTv: widget.onTv))));
                      },
                      child: const Text(
                        'Register now',
                        style : TextStyle(
